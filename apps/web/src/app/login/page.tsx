...
export default function LoginPage() {
  ...
  return <main id="main-content" className="auth-page"><section className="auth-story"><Brand inverse /><div className="auth-story__content"><span className="landing-kicker"><ShieldCheck size={15} />Защищённое рабочее пространство</span><h1>Каждая встреча<br />заканчивается <em>ясностью.</em></h1><p>Транскрипт, итог и поручения — в одном месте, доступном только вашей команде.</p><ul><li><Check size={17} />Русская, казахская и смешанная речь</li><li><Check size={17} />Единый реестр поручений</li><li><Check size={17} />Локальная обработка данных</li></ul></div><small>HATTAMA AI · Қазақстанда жасалған</small></section>
